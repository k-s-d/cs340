module.exports = function(){
    ...
    function getHouses(res, mysql, context) {
      mysql.pool.query("SELECT houseName, houseHead FROM houses", function(error, results, fields){
        if (error){
    ...
    router.post('/', function(req, res){
      var mysql = req.app.get('mysql');
      var sql = "INSERT INTO houses (houseName, houseHead, houseColor) VALUES (?,?,?)";
      var inserts = [req.body.houseName, req.body.houseHead, req.body.houseColor];
